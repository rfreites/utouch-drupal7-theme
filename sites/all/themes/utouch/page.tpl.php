	...
	<div class="container">
		...
		<a href="#" id="top-bar-js" class="top-bar-link"><svg class="utouch-icon utouch-icon-arrow-top"><use xlink:href="#utouch-icon-arrow-top"></use></svg></a>
			...
			<div class="site-logo">
				...
				<img src="<?php print $logo; ?>" alt="<?php print $site_name; ?> <?php echo t('logo');?>">
				<div class="logo-text">
					<div class="logo-title"><?php print $site_name; ?></div>
					<div class="logo-sub-title"><?php print $site_slogan; ?></div>
				</div>
			</div>
